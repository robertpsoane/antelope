...
const CICS = [
  ...
  },
  {
    ...
    short: "OTH",
    description:
      "There may be transcript segments that cannot appropriately be coded using the other themes identified. In such instances, this is coded “OTH” and a brief description is given of what is observed",
    levels: [0],
  },
];
